...
const styles = StyleSheet.create({
  ...
  description: { fontSize: 15, color: colors.textOnDark, marginBottom: 5, lineHeight: 21 },
  row: {
    flexDirection: 'row',
  ...
  label: { fontSize: 14, color: colors.textOnDarkMuted },
  value: { fontSize: 16, fontWeight: '800', color: colors.textOnDark },
});
