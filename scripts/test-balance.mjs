...
// AUCUNE donnée liée au montant n'est transmise (amountBucket retiré, cf. contre-audit Codex).
assert.doesNotMatch(actionsSource, /amountBucket|bucketAmount|amountInEurReference/);
